            ...
            <form action="profileUpdate.php" method="POST">
              <div class="row g-4">
                <div class="input-group form-group mt-auto">
                  <h4><span class="label label-default h-100 me-1 mt-1 text-primary">Resident ID: </span></h4>
                  <input type="text" name="res_id" class="form-control me-5" value="<?php 
                  echo $loggedinRes;
                  ?>" readonly>

                  <h4><span class="label label-default h-100 me-1 mt-1 text-primary">Full Name: </span></h4>
                ...
                <div class="input-group form-group">
                  <h4><span class="label label-default h-100 me-1 mt-1 text-primary">Email: </span></h4>
                  <input type="email" name="email" class="form-control me-5" value="<?php 
                  echo $email;
                  ?>" required>

                  <h4><span class="label label-default h-100 me-1 mt-1 text-primary">Contact Number: </span></h4>
                ...
                <div class="input-group form-group">
                  <h4><span class="label label-default h-100 me-1 mt-1 text-primary">Birthday: </span></h4>
                  <input type="text" name="res_bday" class="form-control me-5" value="<?php 
                  echo $bday;
                  ?>" readonly>

                  <h4><span class="label label-default h-100 me-1 mt-1 text-primary">Gender: </span></h4>
                ...
                <div class="input-group form-group">
                  ...
                  <h4><span class="label label-default h-100 me-1 mt-1 text-primary">Password: </span></h4>
